...
<head>
    <meta charset="UTF-8">
    <title><?php _e('新的任务发布申请', 'help-platform'); ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h2><?php _e('新的任务发布申请', 'help-platform'); ?></h2>
        </div>

        <div class="content">
            <p><?php printf(__('用户 %s 发布了新的任务，请及时审核。', 'help-platform'), $user->display_name); ?></p>
            ...
            <div class="meta">
                <p><strong><?php _e('发布者：', 'help-platform'); ?></strong> <?php echo esc_html($user->display_name); ?></p>
                ...
                if ($latitude && $longitude) {
                    echo '<p><strong>' . __('位置：', 'help-platform') . '</strong> ' . 
